export const enDict = {
    ...
    "about_us": "About Us",
    "about_description1": "PT. Muji Jaya Gaharu is one of the companies engaged in the production and processing of agarwood incense from agarwood located in Pemalang Regency, Central Java. Agarwood is the raw material for various products, including incense and can also be used for Middle Eastern perfumes, particularly those from Saudi Arabia. The company produces incense with a distinctive Saudi Arabian fragrance.",
    "about_description2": "Established in 2015, PT. Muji Jaya Gaharu continues to operate and currently employs more than 300 people, including those in production, drying, and finishing. Additionally, there are workers based in their individual homes.",
    "about_description3": "PT. Muji Jaya Gaharu has successfully exported its products to various Middle Eastern countries such as Riyadh, Jeddah, Qatar, and Dubai. The produced items undergo rigorous quality control processes to ensure the high quality of the products. The company is known for its professionalism in fostering cooperative relationships with customers, leading to commitment and trust.",
    "about_description4": "Furthermore, PT. Muji Jaya Gaharu has a wide market presence throughout Indonesia and internationally, making marketing efforts more extensive and ensuring its continued existence in the industry.",
