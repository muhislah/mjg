        ...
        <div className='md:max-w-5xl md:mx-auto mx-5'>
            <div className='py-10'>
                ...
                <div className='py-5'>
                    <iframe
                        className='w-full'
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3966.8983781179973!2d106.68196487498972!3d-6.14435009384265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNsKwMDgnMzkuNyJTIDEwNsKwNDEnMDQuMyJF!5e0!3m2!1sid!2sid!4v1722832671606!5m2!1sid!2sid"
                        width="600"
                        height="450"
                        style={{ border: 0 }}
                        allowFullScreen={true}
